$(document).ready(function(){
	$('#hidden').hide();
	$('#news_container').css('bottom','116px');
	$('#games_footer').css('bottom','120px');
	$('.turning').click(function(){
		...
		$(window).tlou(function(){
			...
			//$('.info').html("<div class='hidden'><p style='font-size:16px;'>You have found a code to the Dark Horse Digital Comic bundle of The Last of Us: American Dreams.<br/> Tweet to <a href='http://www.twitter.com/naughty_dog' target='_blank' style='font-size:16px;'>@naughty_dog</a> or <a href='http://www.twitter.com/jmpaul' target='_blank' style='font-size:16px;'>@jmpaul</a> letting us know you have won and which page you have found.<br/><br/><b style='font-size:18px;'>VLEF4EP2</b></p>");
